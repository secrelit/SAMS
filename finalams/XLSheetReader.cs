            ...
            for ( row = 1; row < rowcount; row++)
            {
                ...
                else
                {
                   ...
                   // = dc.absent;
                    ...
                    else if ((in_Time == null && out_Time != null) || (in_Time != null && out_Time == null))
                    {
...
;
                    ...
                    else if ((inTimeObject.Hour >= timeFrameDetails.ValidInTime.Hour || inTimeObject.Minute > timeFrameDetails.ValidInTime.Minute))
                    {
                    ...
                    else if ((outTimeObject.Hour <= timeFrameDetails.ValidOutTime.Hour || inTimeObject.Minute <= timeFrameDetails.ValidOutTime.Minute))
                    {
                        ptd.DateCategory = DateCategory.ipt;
                       ptd.Remark= "No Entry";
                    }
